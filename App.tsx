        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1">
             <div className="grid grid-cols-2 gap-4">
               <img src="https://picsum.photos/id/613/400/600" alt="Style 1" className="rounded-lg shadow-xl" />
               <img src="https://picsum.photos/id/1014/400/600" alt="Style 2" className="rounded-lg shadow-xl mt-8" />
             </div>
          </div>
